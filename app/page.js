...
export default function POSPage() {
  ...
  return (
    <div className="max-w-[1200px] mx-auto px-5 py-8">
      {/* ── Header ── */}
      <div className="v-card mb-6 text-center">
        <div className="v-float mx-auto mb-3 w-[60px] h-[60px] rounded-full flex items-center justify-center"
          style={{ background: "linear-gradient(135deg, #C04000, #8B2500)", border: "3px solid #3B2316" }}>
          <Coffee className="w-7 h-7 text-[#FFF8E7]" />
        </div>
        <h1 className="text-3xl font-bold text-[#3B2316]"
          style={{ fontFamily: "'Playfair Display', serif" }}>
          ePOS Cafe Manager
        </h1>
        <p className="text-sm text-[#8B7355] mt-1 italic"
